class CountriesController < ApplicationController
  ...
  def create
    ...
    #@country.social_networks = SocialNetworks.new(social_networks_params)
  ...
  def update
    respond_to do |format|
      if @country.update(country_params) #|| @country.social_networks.update(social_networks_params)
  ...
  private
    ...
    def social_networks_params
      params.require(:social_network).permit(:id, :icon, :url, :description)
    end
